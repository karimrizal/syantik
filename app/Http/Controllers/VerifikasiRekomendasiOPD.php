...
class VerifikasiRekomendasiOPD extends Controller
{
    public function index()
    {
        $rekomendasis = rekomendasi::where('idkab', Auth::user()->idkab )->get();
        $rekomendasis_opd = rekomendasi::where('organisasi', Auth::user()->organisasi )->where('idkab', Auth::user()->idkab )->get();
        $kompromins = kompromin::where('idkab', Auth::user()->idkab )->get();
        return view('verifikasi_rekomendasi_opd',compact('rekomendasis','rekomendasis_opd', 'kompromins'))->with('k', (request()->input('page', 1) - 1) * 5)->with('l', (request()->input('page', 1) - 1) * 5);
        
    }

    public function update_rekomendasi_bps($id)
    {
    ...
    public function update_perbaikan_rekomendasi($id)
    {
    	$category = rekomendasi::find($id);
    ...
    public function edit_perbaikan_rekomendasi(Request $request, $id)
    {
     ...
     public function update_perbaikan_rekomendasi_k($id)
    {
    	$category = kompromin::find($id);
    ...
    public function edit_perbaikan_rekomendasi_k(Request $request, $id)
    {
      ...
      kompromin::updateOrCreate(
       ...
       [
        'perbaikan_opd_k' => $request->perbaikan_opd_k,
        'catatan_perbaikan_k' => $request->catatan_perbaikan_k,
     ...
     public function edit_kompromin_v(Request $request, $id)
    {
     ...
     public function verif_rekomendasi_bps(Request $request, $id)
    {
      rekomendasi::updateOrCreate(
       [
        'id' => $id
       ...
       [
        ...
        'b7r6' => $request->b7r6,
         ...
         'status_bps' => $request->status_bps,
        'komentar_bps' => $request->komentar_bps,
        'petugas_bps' => $request->petugas_bps,
         'tanggal_bps' => Carbon::now()
       ]
      );
