...
class Exports_dda7430 implements FromView, ShouldAutoSize
{
    /**
        ...
        $year= Session::get('key');
            $kab = master_kab::where('idkab', $idkab )->get();
                ...
                $sum_lk = DB::table('tabel_74_30s')
                            ...
                            ->get();
            $tabel_7430 = tabel_74_30::where('tahun', $year)->where('idkab', $idkab )->get();
            
            
             return view('export_dda.tabel_7430',compact('tabel_7430', 'year','kab','sum_lk')
       );
    }
