...
class Exports_dda7429 implements FromView, ShouldAutoSize
{
    /**
        ...
        $year= Session::get('key');
            $kab = master_kab::where('idkab', $idkab )->get();
                ...
                $sum_lk = DB::table('tabel_74_29s')
                            ...
                            ->get();
            $tabel_7429 = tabel_74_29::where('tahun', $year)->where('idkab', $idkab )->get();
            
            
             return view('export_dda.tabel_7429',compact('tabel_7429', 'year','kab','sum_lk')
       );
    }
