...
class Exports_dda7431 implements FromView, ShouldAutoSize
{
    /**
        ...
        $year= Session::get('key');
            $kab = master_kab::where('idkab', $idkab )->get();
                ...
                $sum_lk = DB::table('tabel_74_31s')
                            ...
                            ->get();
            $tabel_7431 = tabel_74_31::where('tahun', $year)->where('idkab', $idkab )->get();
            
            
             return view('export_dda.tabel_7431',compact('tabel_7431', 'year','kab','sum_lk')
       );
    }
