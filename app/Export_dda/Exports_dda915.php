...
class Exports_dda915 implements FromView, ShouldAutoSize
{
    /**
    ...
    public function view(): View
    {
        ...
        $year= Session::get('key');
            ...
            $sum_lk = DB::table('tabel_915s')
                            ...
                            ->get();
            $tabel_915 = tabel_915::where('tahun', $year)->where('idkab', 7400 )->get();
            }
            else{
                $sum_lk = DB::table('tabel_915s')
                            ->selectRaw("sum(t915a) as sum_a, sum(t915b) as sum_b, sum(t915c) as sum_c, sum(t915d) as sum_d, sum(t915e) as sum_e")
            ...
            $tabel_915 = tabel_915::where('tahun', $year)->where('idkab', 7400 )->get();
             ...
             return view('export_dda.tabel_915',compact('tabel_915', 'year','kab','sum_lk')
       );
    }
