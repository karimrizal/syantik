...
class Exports_dda225 implements FromView, ShouldAutoSize
{
    /**
...
if(empty($year)){
            ...
            $sum_lk = DB::table('tabel_225s')
                            ...
                            ->get();
            $tabel_225 = tabel_225::where('tahun', $year)->where('idkab', 7400 )->get();
}
else{
     $sum_lk = DB::table('tabel_225s')
            ...
            $tabel_225 = tabel_225::where('tahun', $year)->where('idkab', 7400 )->get();
             ...
             return view('export_dda.tabel_225',compact('tabel_225', 'year','kab','sum_lk')
       );
    }
