...
class Exports_dda914 implements FromView, ShouldAutoSize
{
    /**
    ...
    public function view(): View
    {
        ...
        $year= Session::get('key');
            ...
            $sum_lk = DB::table('tabel_914s')
                            ...
                            ->get();
            $tabel_914 = tabel_914::where('tahun', $year)->where('idkab', 7400 )->get();
            }
            else{
              $sum_lk = DB::table('tabel_914s')
                            ->selectRaw("sum(t914a) as sum_a,sum(t914b) as sum_b, sum(t914c) as sum_c, sum(t914d) as sum_d")
            ...
            $tabel_914 = tabel_914::where('tahun', $year)->where('idkab', 7400 )->get();  
             ...
             return view('export_dda.tabel_914',compact('tabel_914', 'year','kab','sum_lk')
       );
    }
