...
class Exports_dda7426 implements FromView, ShouldAutoSize
{
    /**
        ...
        $year= Session::get('key');
            $kab = master_kab::where('idkab', $idkab )->get();
                ...
                $sum_lk = DB::table('tabel_74_26s')
                            ...
                            ->get();
            $tabel_7426 = tabel_74_26::where('tahun', $year)->where('idkab', $idkab )->get();
            
            
             return view('export_dda.tabel_7426',compact('tabel_7426', 'year','kab','sum_lk')
       );
    }
