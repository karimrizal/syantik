...
class Exports_dda104 implements FromView, ShouldAutoSize
{
    /**
    ...
    */
    ...
    public function view(): View
    {
        ...
        $year= Session::get('key');
            ...
            ->get();
            $tabel_104 = tabel_104::where('tahun', $year)->where('idkab', 7400 )->get();
            ...
            return view('export_dda.tabel_104',compact('tabel_104', 'year','kab','sum_lk'));
    }
