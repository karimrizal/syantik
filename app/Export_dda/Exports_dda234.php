...
class Exports_dda234 implements FromView, ShouldAutoSize
{
    /**
    ...
    public function view(): View
    {
        ...
        $year= Session::get('key');
            ...
            $sum_lk = DB::table('tabel_234s')
                            ...
                            ->get();
            $tabel_234 = tabel_234::where('tahun', $year)->where('idkab', 7400 )->get();
            }
            else{
              $sum_lk = DB::table('tabel_234s')
            ...
            $tabel_234 = tabel_234::where('tahun', $year)->where('idkab', 7400 )->get();  
             ...
             return view('export_dda.tabel_234',compact('tabel_234', 'year','kab','sum_lk')
       );
    }
