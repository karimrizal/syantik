...
Populasi Unggas Menurut Kabupaten/Kota dan Jenis Unggas (ekor) di {{ $a->kab }}, {{$year}}
@else
Populasi Unggas Menurut Kecamatan dan Jenis Unggas (ekor) di {{ $a->kab }}, {{$year}}
@endif
@endforeach	
</th>
<br>
