						  ...
						  @if( (Auth::user()->role == 'Admin BPS')  || (Auth::user()->role == 'Walidata') || (Auth::user()->role == 'Admin OPD') || (Auth::user()->role == 'Operator OPD')|| (Auth::user()->role == 'Admin BPS Kabupaten') ) <li>
							...
							<div id="subPages2" class="collapse in" aria-expanded="false" style="">
								<ul class="nav">
									...
									<li><a href="verifikasi_kegiatan" class="active">Hasil Verifikasi Kegiatan</a></li>
											...
											<td> @if($result->status_opd =='Tampil')<center> <i class="fa fa-check" style="color:green"></i></center>
                                              ...
                                              @elseif(is_null($result->status_wali) || $result->status_wali == 'Tidak Tampil'  )
                                                ...
                                                @elseif (is_null($result->status_tampil) && $result->status_wali == 'Tampil' )
                                                 <td> <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_kegiatan/' . $result->id) }}'" class="btn btn-primary btn-sm">Verifikasi</button>
                                                  </td>
											...
											<td> @if($result->status_opd =='Tampil')<center> <i class="fa fa-check" style="color:green"></i></center>
                                              ...
                                              @if(is_null($result->status_opd))
                                                ...
                                                @elseif (is_null($result->status_wali) && $result->status_opd == 'Tampil' )
                                                 <td> <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_kegiatan_wali/' . $result->id) }}'" class="btn btn-primary btn-sm">Verifikasi</button>
                                                  </td>
                                ...
                                <div class="modal-body">
                                 ...
                                 <div class="modal-footer">
                                     <button type="button" class="btn btn-default" data-dismiss="modal">Kembali</button>
                                                 ...
                                                 <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_kegiatan_wali/' . $result->id) }}'" class="btn btn-primary btn-sm">Ubah Verifikasi</button>	
									...
									@foreach ($list_meta_kegiatan_opd as $result)
										<tr id="iid{{ $result->id }}">
											...
											<td>{{ $result->b0r1 }}</td>
                                                ...
                                                @if (is_null($result->status_opd)  )
                                                 <td> <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_kegiatan_opd/' . $result->id) }}'" class="btn btn-primary btn-sm">Verifikasi</button>
                                                  </td>
                                             ...
                                             <br>
                                             <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_kegiatan_opd/' . $result->id) }}'" class="btn btn-primary btn-sm">Ubah Verifikasi</button>	
