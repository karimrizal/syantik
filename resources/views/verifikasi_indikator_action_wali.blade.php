				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
							<form action="{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_indikator_wali') }}" method="POST">
								@csrf
								@foreach ($data as $result)
								<input type="hidden" id="id" name="id" value="{{ $result->id }}">
								<input type="hidden" id="petugas_wali" name="petugas_wali" value="{{Auth::user()->name}}">
								...
								<div class="form-group">
									...
									<input type="radio" name="status_wali" id="status_wali" value="Tampil" required>
									<label for="tampil">Tampil</label><br>
									<input type="radio" name="status_wali" id="status_wali" value="Tidak Tampil" required>
									<label for="tidak_tampil">Tidak Tampil</label>
								</div>
								<div class="form-group">
									<label for="alasan_tampil_wali">Keteranganl</label>
									<input class="form-control" type="text" name="alasan_tampil_wali" id="alasan_tampil_wali" value="{{ $result->alasan_tampil_wali }}" />
								</div>
