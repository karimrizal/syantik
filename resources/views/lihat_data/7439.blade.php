 ...
 (Persen)</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7439a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7439a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7439b))
                            <td>
                                <center> {{number_format(($member->t7439b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7439b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7439c))
                            <td>
                                <center> {{number_format(($member->t7439c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7439c}} </center>
                            </td>
                            @endif    
