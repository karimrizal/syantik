                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t741a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t741a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t741b))
                            <td>
                                <center> {{number_format(($member->t741b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t741b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t741c))
                            <td>
                                <center> {{number_format(($member->t741c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t741c}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t741d))
                            <td>
                                <center> {{number_format(($member->t741d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t741d}} </center>
                            </td>
                            @endif     
                            
                            @if(is_numeric($member->t741e))
                            <td>
                                <center> {{number_format(($member->t741e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t741e}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t741f))
                            <td>
                                <center> {{number_format(($member->t741f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t741f}} </center>
                            </td>
                            @endif     
