                  ...
                  <th bgcolor="#5cb85c" style="vertical-align: middle;" > <center>Organisasi dll</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7418a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7418a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7418b))
                            <td>
                                <center> {{number_format(($member->t7418b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7418b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7418c))
                            <td>
                                <center> {{number_format(($member->t7418c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7418c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t7418d))
                            <td>
                                <center> {{number_format(($member->t7418d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7418d}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7418e))
                            <td>
                                <center> {{number_format(($member->t7418e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7418e}} </center>
                            </td>
                            @endif 
