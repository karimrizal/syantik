                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t551a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t551a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t551b))
                            <td>
                                <center> {{number_format(($member->t551b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t551b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t551c))
                            <td>
                                <center> {{number_format(($member->t551c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t551c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t551d))
                            <td>
                                <center> {{number_format(($member->t551d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t551d}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t551e))
                            <td>
                                <center> {{number_format(($member->t551e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t551e}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t551f))
                            <td>
                                <center> {{number_format(($member->t551f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t551f}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t551g))
                            <td>
                                <center> {{number_format(($member->t551g),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t551g}} </center>
                            </td>
                            @endif
