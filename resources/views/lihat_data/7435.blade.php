                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7435a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7435a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7435b))
                            <td>
                                <center> {{number_format(($member->t7435b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7435b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7435c))
                            <td>
                                <center> {{number_format(($member->t7435c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7435c}} </center>
                            </td>
                            @endif    
