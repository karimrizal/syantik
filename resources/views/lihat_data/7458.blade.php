                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7458a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7458a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7458b))
                            <td>
                                <center> {{number_format(($member->t7458b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7458b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7458c))
                            <td>
                                <center> {{number_format(($member->t7458c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7458c}} </center>
                            </td>
                            @endif
