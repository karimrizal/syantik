                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7421a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7421a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7421b))
                            <td>
                                <center> {{number_format(($member->t7421b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7421b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7421c))
                            <td>
                                <center> {{number_format(($member->t7421c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7421c}} </center>
                            </td>
                            @endif    
