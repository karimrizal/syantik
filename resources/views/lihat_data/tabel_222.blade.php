                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t222a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t222a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t222b))
                            <td>
                                <center> {{number_format(($member->t222b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t222b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t222c))
                            <td>
                                <center> {{number_format(($member->t222c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t222c}} </center>
                            </td>
                            @endif    
