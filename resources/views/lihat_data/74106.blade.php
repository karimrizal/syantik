                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74106a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74106a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74106b))
                            <td>
                                <center> {{number_format(($member->t74106b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74106b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74106c))
                            <td>
                                <center> {{number_format(($member->t74106c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74106c}} </center>
                            </td>
                            @endif
