                  ...
                  <th bgcolor="#5cb85c" style="vertical-align: middle;" > <center>P</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7466a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7466a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7466b))
                            <td>
                                <center> {{number_format(($member->t7466b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7466b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7466c))
                            <td>
                                <center> {{number_format(($member->t7466c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7466c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t7466d))
                            <td>
                                <center> {{number_format(($member->t7466d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7466d}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7466e))
                            <td>
                                <center> {{number_format(($member->t7466e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7466e}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7466f))
                            <td>
                                <center> {{number_format(($member->t7466f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7466f}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t7466g))
                            <td>
                                <center> {{number_format(($member->t7466g),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7466g}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t7466h))
                            <td>
                                <center> {{number_format(($member->t7466h),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7466h}} </center>
                            </td>
                            @endif
