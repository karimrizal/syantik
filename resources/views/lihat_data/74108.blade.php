                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74108a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74108a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74108b))
                            <td>
                                <center> {{number_format(($member->t74108b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74108b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74108c))
                            <td>
                                <center> {{number_format(($member->t74108c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74108c}} </center>
                            </td>
                            @endif
