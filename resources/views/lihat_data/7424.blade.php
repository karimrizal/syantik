...
(Rp.)</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7424a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7424a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7424b))
                            <td>
                                <center> {{number_format(($member->t7424b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7424b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7424c))
                            <td>
                                <center> {{number_format(($member->t7424c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7424c}} </center>
                            </td>
                            @endif    
