                  ...
                  <th bgcolor="#5cb85c" style="vertical-align: middle;" > <center>Persentase Tindaklanjut</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7444a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7444a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7444b))
                            <td>
                                <center> {{number_format(($member->t7444b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7444b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7444c))
                            <td>
                                <center> {{number_format(($member->t7444c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7444c}} </center>
                            </td>
                            @endif
