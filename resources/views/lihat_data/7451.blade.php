                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7451a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7451a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7451b))
                            <td>
                                <center> {{number_format(($member->t7451b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7451b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7451c))
                            <td>
                                <center> {{number_format(($member->t7451c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7451c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t7451d))
                            <td>
                                <center> {{number_format(($member->t7451d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7451d}} </center>
                            </td>
                            @endif 
