                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t552a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t552a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t552b))
                            <td>
                                <center> {{number_format(($member->t552b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t552b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t552c))
                            <td>
                                <center> {{number_format(($member->t552c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t552c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t552d))
                            <td>
                                <center> {{number_format(($member->t552d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t552d}} </center>
                            </td>
                            @endif 
