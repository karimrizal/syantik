                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                           ...
                           @if(is_numeric($member->t103a))
                            <td>
                               <center>  {{number_format(($member->t103a),0, '.','')}} </center>
                            </td>
                           
                           @else
                              <td>
                              <center>  {{$member->t103a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t103b))
                            <td>
                             <center>   {{number_format(($member->t103b),0, '.','')}} </center>
                            </td>
                           
                           @else
                              <td>
                             <center>  {{$member->t103b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t103c))
                            <td>
                            <center>   {{number_format(($member->t103c),0, '.','')}} </center>
                            </td>
                           
                           @else
                              <td>
                              <center>  {{$member->t103c}} </center>
                            </td>
                            @endif    
