                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74102a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74102a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74102b))
                            <td>
                                <center> {{number_format(($member->t74102b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74102b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74102c))
                            <td>
                                <center> {{number_format(($member->t74102c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74102c}} </center>
                            </td>
                            @endif
