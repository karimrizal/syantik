                  ...
                  <th bgcolor="#5cb85c" style="vertical-align: middle;" > <center>2021</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7483a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7483a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7483b))
                            <td>
                                <center> {{number_format(($member->t7483b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7483b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7483c))
                            <td>
                                <center> {{number_format(($member->t7483c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7483c}} </center>
                            </td>
                            @endif
