                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74101a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74101a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74101b))
                            <td>
                                <center> {{number_format(($member->t74101b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74101b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74101c))
                            <td>
                                <center> {{number_format(($member->t74101c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74101c}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t74101d))
                            <td>
                                <center> {{number_format(($member->t74101d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74101d}} </center>
                            </td>
                            @endif     
                            
                            @if(is_numeric($member->t74101e))
                            <td>
                                <center> {{number_format(($member->t74101e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74101e}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t74101f))
                            <td>
                                <center> {{number_format(($member->t74101f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74101f}} </center>
                            </td>
                            @endif     
