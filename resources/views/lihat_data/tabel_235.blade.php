                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t235_lk),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t235_lk}} </center>
                            </td>
                            @endif    
                            @if(is_numeric($member->t235_pr))
                            <td>
                               <center> {{number_format(($member->t235_pr),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t235_pr}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t235c))
                            <td>
                                <center> {{number_format(($member->t235c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t235c}} </center>
                            </td>
                            @endif 
