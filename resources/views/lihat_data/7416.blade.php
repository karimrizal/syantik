                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7416a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7416a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7416b))
                            <td>
                                <center> {{number_format(($member->t7416b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7416b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7416c))
                            <td>
                                <center> {{number_format(($member->t7416c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7416c}} </center>
                            </td>
                            @endif    
