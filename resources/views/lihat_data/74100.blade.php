                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74100a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74100a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74100b))
                            <td>
                                <center> {{number_format(($member->t74100b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74100b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74100c))
                            <td>
                                <center> {{number_format(($member->t74100c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74100c}} </center>
                            </td>
                            @endif
