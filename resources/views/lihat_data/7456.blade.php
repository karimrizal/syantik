                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7456a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7456a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7456b))
                            <td>
                                <center> {{number_format(($member->t7456b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7456b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7456c))
                            <td>
                                <center> {{number_format(($member->t7456c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7456c}} </center>
                            </td>
                            @endif    
