                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t4211a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t4211a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t4211b))
                            <td>
                                <center> {{number_format(($member->t4211b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t4211b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t4211c))
                            <td>
                                <center> {{number_format(($member->t4211c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t4211c}} </center>
                            </td>
                            @endif    
