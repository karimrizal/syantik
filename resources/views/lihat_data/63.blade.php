...
<table class="table table-bordered" id="example3">
                <thead>
                    ...
                    <tr>
                        ...
                        <th bgcolor="#5cb85c" style="vertical-align: middle;"> <center>Air Disalurkan</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t63a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t63a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t63b))
                            <td>
                                <center> {{number_format(($member->t63b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t63b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t63c))
                            <td>
                                <center> {{number_format(($member->t63c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t63c}} </center>
                            </td>
                            @endif    
