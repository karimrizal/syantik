                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7457a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7457a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7457b))
                            <td>
                                <center> {{number_format(($member->t7457b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7457b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7457c))
                            <td>
                                <center> {{number_format(($member->t7457c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7457c}} </center>
                            </td>
                            @endif
