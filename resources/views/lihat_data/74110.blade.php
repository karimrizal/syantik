                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74110a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74110a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74110b))
                            <td>
                                <center> {{number_format(($member->t74110b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74110b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74110c))
                            <td>
                                <center> {{number_format(($member->t74110c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74110c}} </center>
                            </td>
                            @endif
