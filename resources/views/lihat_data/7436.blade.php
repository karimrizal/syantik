...
<th bgcolor="#5cb85c" style="vertical-align: middle;" > <center>Total</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7436a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7436a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7436b))
                            <td>
                                <center> {{number_format(($member->t7436b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7436b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7436c))
                            <td>
                                <center> {{number_format(($member->t7436c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7436c}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t7436d))
                            <td>
                                <center> {{number_format(($member->t7436d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7436d}} </center>
                            </td>
                            @endif     
                            
                            @if(is_numeric($member->t7436e))
                            <td>
                                <center> {{number_format(($member->t7436e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7436e}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t7436f))
                            <td>
                                <center> {{number_format(($member->t7436f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7436f}} </center>
                            </td>
                            @endif     
                            
                             @if(is_numeric($member->t7436g))
                            <td>
                                <center> {{number_format(($member->t7436g),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7436g}} </center>
                            </td>
                            @endif     
