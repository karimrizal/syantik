                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t466a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t466a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t466b))
                            <td>
                                <center> {{number_format(($member->t466b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t466b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t466c))
                            <td>
                                <center> {{number_format(($member->t466c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t466c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t466d))
                            <td>
                                <center> {{number_format(($member->t466d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t466d}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t466e))
                            <td>
                                <center> {{number_format(($member->t466e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t466e}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t466f))
                            <td>
                                <center> {{number_format(($member->t466f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t466f}} </center>
                            </td>
                            @endif
