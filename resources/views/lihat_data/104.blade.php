                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                               <center> {{number_format(($member->t104a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center>  {{$member->t104a}}  </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t104b))
                            <td>
                              <center>   {{number_format(($member->t104b),0, '.',' ')}}  </center>
                            </td>
                           
                           @else
                              <td>
                             <center>   {{$member->t104b}}  </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t104c))
                            <td>
                             <center>    {{number_format(($member->t104c),0, '.',' ')}}   </center>
                            </td>
                           
                           @else
                              <td>
                             <center>    {{$member->t104c}}  </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t104d))
                            <td>
                             <center>   {{number_format(($member->t104d),0, '.',' ')}}   </center>
                            </td>
                           
                           @else
                              <td>
                             <center>  {{$member->t104d}}   </center>
                            </td>
                            @endif 
