                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7450a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7450a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7450b))
                            <td>
                                <center> {{number_format(($member->t7450b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7450b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7450c))
                            <td>
                                <center> {{number_format(($member->t7450c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7450c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t7450d))
                            <td>
                                <center> {{number_format(($member->t7450d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7450d}} </center>
                            </td>
                            @endif 
