                  ...
                  <tr>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t914a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t914a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t914b))
                            <td>
                                <center> {{number_format(($member->t914b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t914b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t914c))
                            <td>
                                <center> {{number_format(($member->t914c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t914c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t914d))
                            <td>
                                <center> {{number_format(($member->t914d),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t914d}} </center>
                            </td>
                            @endif 
