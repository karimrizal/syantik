                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74107a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74107a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74107b))
                            <td>
                                <center> {{number_format(($member->t74107b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74107b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74107c))
                            <td>
                                <center> {{number_format(($member->t74107c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74107c}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t74107d))
                            <td>
                                <center> {{number_format(($member->t74107d),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74107d}} </center>
                            </td>
                            @endif     
                            
                            @if(is_numeric($member->t74107e))
                            <td>
                                <center> {{number_format(($member->t74107e),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74107e}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t74107f))
                            <td>
                                <center> {{number_format(($member->t74107f),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74107f}} </center>
                            </td>
                            @endif     
