                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7464a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7464a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7464b))
                            <td>
                                <center> {{number_format(($member->t7464b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7464b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7464c))
                            <td>
                                <center> {{number_format(($member->t7464c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7464c}} </center>
                            </td>
                            @endif     
