                  ...
                  <th bgcolor="#5cb85c" style="vertical-align: middle;" > <center>Persentase Tindaklanjut</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7445a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7445a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7445b))
                            <td>
                                <center> {{number_format(($member->t7445b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7445b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7445c))
                            <td>
                                <center> {{number_format(($member->t7445c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7445c}} </center>
                            </td>
                            @endif
