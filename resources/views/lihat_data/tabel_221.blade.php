                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t221a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t221a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t221b))
                            <td>
                                <center> {{number_format(($member->t221b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t221b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t221c))
                            <td>
                                <center> {{number_format(($member->t221c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t221c}} </center>
                            </td>
                            @endif    
