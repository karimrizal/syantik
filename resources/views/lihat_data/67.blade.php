                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t67a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t67a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t67b))
                            <td>
                                <center> {{number_format(($member->t67b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t67b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t67c))
                            <td>
                                <center> {{number_format(($member->t67c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t67c}} </center>
                            </td>
                            @endif    
