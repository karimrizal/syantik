...
<h3 class="panel-title" style="font-weight: 500; font-size: 20px; color: #006fcc;">Persentase ASN yang Mengikuti Pendidikan dan Pelatihan Formal, Tahun 2018-2022</h3>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7442a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7442a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7442b))
                            <td>
                                <center> {{number_format(($member->t7442b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7442b}} </center>
                            </td>
                            @endif
