                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7452a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7452a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7452b))
                            <td>
                                <center> {{number_format(($member->t7452b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7452b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7452c))
                            <td>
                                <center> {{number_format(($member->t7452c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7452c}} </center>
                            </td>
                            @endif    
