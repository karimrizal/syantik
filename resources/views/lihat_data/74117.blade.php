                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74117a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74117a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74117b))
                            <td>
                                <center> {{number_format(($member->t74117b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74117b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74117c))
                            <td>
                                <center> {{number_format(($member->t74117c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74117c}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t74117d))
                            <td>
                                <center> {{number_format(($member->t74117d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74117d}} </center>
                            </td>
                            @endif     
                            
                            @if(is_numeric($member->t74117e))
                            <td>
                                <center> {{number_format(($member->t74117e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74117e}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t74117f))
                            <td>
                                <center> {{number_format(($member->t74117f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74117f}} </center>
                            </td>
                            @endif     
