                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t234_lk),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t234_lk}} </center>
                            </td>
                            @endif    
                            @if(is_numeric($member->t234_pr))
                            <td>
                               <center> {{number_format(($member->t234_pr),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t234_pr}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t234c))
                            <td>
                                <center> {{number_format(($member->t234c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t234c}} </center>
                            </td>
                            @endif 
