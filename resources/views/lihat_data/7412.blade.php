                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7412a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7412a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7412b))
                            <td>
                                <center> {{number_format(($member->t7412b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7412b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7412c))
                            <td>
                                <center> {{number_format(($member->t7412c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7412c}} </center>
                            </td>
                            @endif    
