                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t744a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t744a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t744b))
                            <td>
                                <center> {{number_format(($member->t744b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t744b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t744c))
                            <td>
                                <center> {{number_format(($member->t744c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t744c}} </center>
                            </td>
                            @endif    
