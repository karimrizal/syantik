                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7422a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7422a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7422b))
                            <td>
                                <center> {{number_format(($member->t7422b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7422b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7422c))
                            <td>
                                <center> {{number_format(($member->t7422c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7422c}} </center>
                            </td>
                            @endif
