                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74112a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74112a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74112b))
                            <td>
                                <center> {{number_format(($member->t74112b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74112b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74112c))
                            <td>
                                <center> {{number_format(($member->t74112c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74112c}} </center>
                            </td>
                            @endif
