                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7449a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7449a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7449b))
                            <td>
                                <center> {{number_format(($member->t7449b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7449b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7449c))
                            <td>
                                <center> {{number_format(($member->t7449c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7449c}} </center>
                            </td>
                            @endif    
