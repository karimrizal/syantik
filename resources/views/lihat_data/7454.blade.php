                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7454a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7454a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7454b))
                            <td>
                                <center> {{number_format(($member->t7454b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7454b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7454c))
                            <td>
                                <center> {{number_format(($member->t7454c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7454c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t7454d))
                            <td>
                                <center> {{number_format(($member->t7454d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7454d}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7454e))
                            <td>
                                <center> {{number_format(($member->t7454e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7454e}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7454f))
                            <td>
                                <center> {{number_format(($member->t7454f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7454f}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t7454g))
                            <td>
                                <center> {{number_format(($member->t7454g),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7454g}} </center>
                            </td>
                            @endif
