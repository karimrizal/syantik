                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7411a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7411a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7411b))
                            <td>
                                <center> {{number_format(($member->t7411b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7411b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7411c))
                            <td>
                                <center> {{number_format(($member->t7411c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7411c}} </center>
                            </td>
                            @endif
