                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74104a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74104a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74104b))
                            <td>
                                <center> {{number_format(($member->t74104b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74104b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74104c))
                            <td>
                                <center> {{number_format(($member->t74104c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74104c}} </center>
                            </td>
                            @endif
