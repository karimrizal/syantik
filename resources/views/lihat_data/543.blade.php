                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                              ...
                              <td>
                                <center> {{$member->t543a}} </center>
                            </td>
                             @if(is_numeric($member->t543b))
                            <td>
                                <center> {{number_format(($member->t543b),0, '.','')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t543b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t543c))
                            <td>
                                <center> {{number_format(($member->t543c),0, '.','')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t543c}} </center>
                            </td>
                            @endif    
