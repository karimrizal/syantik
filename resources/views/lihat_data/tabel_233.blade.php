                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t233_lk),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t233_lk}} </center>
                            </td>
                            @endif    
                            @if(is_numeric($member->t233_pr))
                            <td>
                               <center> {{number_format(($member->t233_pr),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t233_pr}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t233c))
                            <td>
                                <center> {{number_format(($member->t233c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t233c}} </center>
                            </td>
                            @endif 
