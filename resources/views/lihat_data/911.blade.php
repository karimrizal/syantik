                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t911a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t911a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t911b))
                            <td>
                                <center> {{number_format(($member->t911b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t911b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t911c))
                            <td>
                                <center> {{number_format(($member->t911c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t911c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t911d))
                            <td>
                                <center> {{number_format(($member->t911d),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t911d}} </center>
                            </td>
                            @endif 
