...
bencana dan/atau berpotensi bencana </center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t74105a),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74105a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t74105b))
                            <td>
                                <center> {{number_format(($member->t74105b),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74105b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t74105c))
                            <td>
                                <center> {{number_format(($member->t74105c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t74105c}} </center>
                            </td>
                            @endif
