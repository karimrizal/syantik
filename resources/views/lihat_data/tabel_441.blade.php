                ...
                <th bgcolor="#5cb85c" style="vertical-align: middle;"><center>Selang Waktu Terjadinya Tindak Pidana</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t441a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t441a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t441b))
                            <td>
                                <center> {{number_format(($member->t441b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t441b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t441c))
                            <td>
                                <center> {{number_format(($member->t441c),2, '.',' ')}} </center>
                            </td>
                            
                            @else
                              <td>
                                <center> {{$member->t441c}} </center>
                            </td>
                            @endif    
                            <td>
                                <center> {{$member->t441d}} </center>
                            </td>
