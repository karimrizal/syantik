...
(%)</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7441a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7441a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7441b))
                            <td>
                                <center> {{number_format(($member->t7441b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7441b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7441c))
                            <td>
                                <center> {{number_format(($member->t7441c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7441c}} </center>
                            </td>
                            @endif
