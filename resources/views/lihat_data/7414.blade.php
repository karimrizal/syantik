                  ...
                  <th bgcolor="#5cb85c" style="vertical-align: middle;" > <center>P</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7414a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7414a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7414b))
                            <td>
                                <center> {{number_format(($member->t7414b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7414b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7414c))
                            <td>
                                <center> {{number_format(($member->t7414c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7414c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t7414d))
                            <td>
                                <center> {{number_format(($member->t7414d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7414d}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7414e))
                            <td>
                                <center> {{number_format(($member->t7414e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7414e}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7414f))
                            <td>
                                <center> {{number_format(($member->t7414f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7414f}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t7414g))
                            <td>
                                <center> {{number_format(($member->t7414g),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7414g}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7414h))
                            <td>
                                <center> {{number_format(($member->t7414h),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7414h}} </center>
                            </td>
                            @endif
