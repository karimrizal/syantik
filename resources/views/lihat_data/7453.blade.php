                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7453a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7453a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7453b))
                            <td>
                                <center> {{number_format(($member->t7453b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7453b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7453c))
                            <td>
                                <center> {{number_format(($member->t7453c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7453c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t7453d))
                            <td>
                                <center> {{number_format(($member->t7453d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7453d}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7453e))
                            <td>
                                <center> {{number_format(($member->t7453e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7453e}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7453f))
                            <td>
                                <center> {{number_format(($member->t7453f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7453f}} </center>
                            </td>
                            @endif
                            
                            @if(is_numeric($member->t7453g))
                            <td>
                                <center> {{number_format(($member->t7453g),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7453g}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7453h))
                            <td>
                                <center> {{number_format(($member->t7453h),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7453h}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7453i))
                            <td>
                                <center> {{number_format(($member->t7453i),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7453i}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7453j))
                            <td>
                                <center> {{number_format(($member->t7453j),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7453j}} </center>
                            </td>
                            @endif
