                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t231_lk),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t231_lk}} </center>
                            </td>
                            @endif    
                            @if(is_numeric($member->t231_pr))
                            <td>
                               <center> {{number_format(($member->t231_pr),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t231_pr}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t231c))
                            <td>
                                <center> {{number_format(($member->t231c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t231c}} </center>
                            </td>
                            @endif    
