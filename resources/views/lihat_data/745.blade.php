                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t745a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t745a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t745b))
                            <td>
                                <center> {{number_format(($member->t745b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t745b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t745c))
                            <td>
                                <center> {{number_format(($member->t745c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t745c}} </center>
                            </td>
                            @endif    
