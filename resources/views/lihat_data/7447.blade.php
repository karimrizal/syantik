                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7447a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7447a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7447b))
                            <td>
                                <center> {{number_format(($member->t7447b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7447b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7447c))
                            <td>
                                <center> {{number_format(($member->t7447c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7447c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t7447d))
                            <td>
                                <center> {{number_format(($member->t7447d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7447d}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7447e))
                            <td>
                                <center> {{number_format(($member->t7447e),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7447e}} </center>
                            </td>
                            @endif 
                            
                             @if(is_numeric($member->t7447f))
                            <td>
                                <center> {{number_format(($member->t7447f),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7447f}} </center>
                            </td>
                            @endif
