...
<h3 class="panel-title" style="font-weight: 500; font-size: 20px; color: #006fcc;">Rasio Elektrifikasi (RE) Menurut Kabupaten/Kota di Provinsi Sulawesi Tenggara, {{$year}}Rasio Elektrifikasi (RE) Menurut Kabupaten/Kota di Provinsi Sulawesi Tenggara, {{$year}}</h3>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7465a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7465a}} </center>
                            </td>
                            @endif   
                            
                             @if(is_numeric($member->t7465b))
                            <td>
                                <center> {{number_format(($member->t7465b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7465b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7465c))
                            <td>
                                <center> {{number_format(($member->t7465c),2, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7465c}} </center>
                            </td>
                            @endif     
