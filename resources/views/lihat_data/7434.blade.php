                  ...
                  <th bgcolor="#5cb85c" style="vertical-align: middle;"  > <center>Lainnya</center></th>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7434a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7434a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7434b))
                            <td>
                                <center> {{number_format(($member->t7434b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7434b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7434c))
                            <td>
                                <center> {{number_format(($member->t7434c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7434c}} </center>
                            </td>
                            @endif    
                            
                            @if(is_numeric($member->t7434d))
                            <td>
                                <center> {{number_format(($member->t7434d),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7434d}} </center>
                            </td>
                            @endif 
