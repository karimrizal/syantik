                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                <center> {{number_format(($member->t7420a),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                               <center> {{$member->t7420a}} </center>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t7420b))
                            <td>
                                <center> {{number_format(($member->t7420b),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7420b}} </center>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t7420c))
                            <td>
                                <center> {{number_format(($member->t7420c),0, '.',' ')}} </center>
                            </td>
                           
                           @else
                              <td>
                                <center> {{$member->t7420c}} </center>
                            </td>
                            @endif    
