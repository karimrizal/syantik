				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Edit Metadata Variabel</h3>
						</div>
						<div class="panel-body">
							<form action="{{ url('https://webapps.bps.go.id/sultra/syantik/edit_metadata_variabel') }}" method="POST">
								@csrf
								@foreach ($data as $result)
								<input type="hidden" name="id" value="{{ $result->id }}">
								<div class="form-group">
									<label for="var_b1k2">Nama Variabel</label>
									<input type="text" class="form-control" name="var_b1k2" value="{{ $result->var_b1k2 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k3">Alias</label>
									<input type="text" class="form-control" name="var_b1k3" value="{{ $result->var_b1k3 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k4">Konsep</label>
									<input type="text" class="form-control" name="var_b1k4" value="{{ $result->var_b1k4 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k5">Definisi</label>
									<input type="text" class="form-control" name="var_b1k5" value="{{ $result->var_b1k5 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k6">Referensi Pemilihan</label>
									<input type="text" class="form-control" name="var_b1k6" value="{{ $result->var_b1k6 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k7">Referensi Waktu</label>
									<input type="text" class="form-control" name="var_b1k7" value="{{ $result->var_b1k7 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k8">Tipe result</label>
									<input type="text" class="form-control" name="var_b1k8" value="{{ $result->var_b1k8 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k9">Klasifikasi Isian</label>
									<input type="text" class="form-control" name="var_b1k9" value="{{ $result->var_b1k9 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k10">Aturan Validasi</label>
									<input type="text" class="form-control" name="var_b1k10" value="{{ $result->var_b1k10 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k11">Kalimat Pertanyaan</label>
									<input type="text" class="form-control" name="var_b1k11" value="{{ $result->var_b1k11 }}" >
								</div>
								<div class="form-group">
									<label for="var_b1k12">Apakah Variabel Dapat Diakses Umum</label>
									<input type="text" class="form-control" name="var_b1k12" value="{{ $result->var_b1k12 }}" >
								</div>
								<button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/metadata_variabel') }}'" type="button" class="btn btn-danger float-left">Kembali</button>
