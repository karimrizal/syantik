		...
		<div class="main">
			...
			<div class="main-content">
               ...
               <p class="page-title text-left"><a href="data_dda"><i class="lnr lnr-arrow-left-circle"></i> Kembali</a></p>
                           <br>
                            <hr><a href="{{ url('/export_923') }}"><button type="button" class="btn btn-primary btn-md">Unduh Template</button></a>	
                            <a href="{{ url('/ekspor_923') }}"><button type="button" class="btn btn-primary" style="float: right;background-color:#006fcc;">Ekspor Excel</button></a>
<br>
<br>    
					@foreach($kab as $a)				
...
<table class="table table-bordered" id="example3">
    ...
    <div class="col-md-6">
        	...
        	<table class="table table-bordered" id="example4">
                ...
                <tr> <th bgcolor="#5cb85c" style="vertical-align: middle;" colspan="3"><center>2020</center></th> </tr>
                    <tr>
