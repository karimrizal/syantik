		...
		<div class="main">
			...
			<div class="main-content">
               ...
               <p class="page-title text-left"><a href="data_dda"><i class="lnr lnr-arrow-left-circle"></i> Kembali</a></p>
                           <br>
                           <hr><a href="{{ url('/export_531') }}"><button type="button" class="btn btn-primary btn-md">Unduh Template</button></a>	
                           <a href="{{ url('/ekspor_531') }}"><button type="button" class="btn btn-primary" style="float: right;background-color:#006fcc;">Ekspor Excel</button></a>
<br>
<br>    
					@foreach($kab as $a)
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                           ...
                           <input type="hidden" id="updated_at" name="members[{{ $i }}][updated_at]" class="form-control"  value={{ \Carbon\Carbon::now() }} >  
                            ...
                            <td>
                                <input type="text" id="t531a" name="members[{{ $i }}][t531a]" class="form-control" value="{{number_format(($member->t531a),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531b" name="members[{{ $i }}][t531b]" class="form-control" value="{{number_format(($member->t531b),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531c" name="members[{{ $i }}][t531c]" class="form-control" value="{{number_format(($member->t531c),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531d" name="members[{{ $i }}][t531d]" class="form-control" value="{{number_format(($member->t531d),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531e" name="members[{{ $i }}][t531e]" class="form-control" value="{{number_format(($member->t531e),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531f" name="members[{{ $i }}][t531f]" class="form-control" value="{{number_format(($member->t531f),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531g" name="members[{{ $i }}][t531g]" class="form-control" value="{{number_format(($member->t531g),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531h" name="members[{{ $i }}][t531h]" class="form-control" value="{{number_format(($member->t531h),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531i" name="members[{{ $i }}][t531i]" class="form-control" value="{{number_format(($member->t531i),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531j" name="members[{{ $i }}][t531j]" class="form-control" value="{{number_format(($member->t531j),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531k" name="members[{{ $i }}][t531k]" class="form-control" value="{{number_format(($member->t531k),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531l" name="members[{{ $i }}][t531l]" class="form-control" value="{{number_format(($member->t531l),0, '.','')}}">
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                <input type="text" id="t531m" name="members[{{ $i }}][t531m]" class="form-control" value="{{number_format(($member->t531m),0, '.','')}}">
                            </td>
               ...
               @foreach ($tes as $member)
                    <tr>
                      ...
                      <th>{{ $member->kec }}</th>
                              ...
                              @if(is_numeric($member->t531a))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531a),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif    
                             ...
                             @if(is_numeric($member->t531b))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531b),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif
                             ...
                             @if(is_numeric($member->t531c))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531c),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @if(is_numeric($member->t531d))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531d),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif 
                             ...
                             @if(is_numeric($member->t531e))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531e),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif 
                             ...
                             @if(is_numeric($member->t531f))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531f),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif
                             ...
                             @if(is_numeric($member->t531g))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531g),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif
                             ...
                             @if(is_numeric($member->t531h))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531h),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif
                             ...
                             @if(is_numeric($member->t531i))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531i),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif
                             ...
                             @if(is_numeric($member->t531j))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531j),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif
                             ...
                             @if(is_numeric($member->t531k))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531k),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @endif
                             ...
                             @if(is_numeric($member->t531l))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531l),0, '.',' ')}}">
                            </td>
                           ...
                           @else
                            ...
                            @if(is_numeric($member->t531m))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t531m),0, '.',' ')}}">
                            </td>
