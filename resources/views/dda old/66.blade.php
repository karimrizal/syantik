		...
		<div class="main">
			...
			<div class="main-content">
               ...
               <p class="page-title text-left"><a href="data_dda"><i class="lnr lnr-arrow-left-circle"></i> Kembali</a></p>
                           <br>
                           <hr><a href="{{ url('/export_66') }}"><button type="button" class="btn btn-primary btn-md">Unduh Template</button></a>	
                           <a href="{{ url('/ekspor_66') }}"><button type="button" class="btn btn-primary" style="float: right;background-color:#006fcc;">Ekspor Excel</button></a>
<br>
<br>    
					@foreach($kab as $a)				
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                         ...
                         <form id="simpan" action="{{ route('dda.store66') }}" method="POST">
                             @csrf
                           ...
                           <input type="hidden" id="updated_at" name="members[{{ $i }}][updated_at]" class="form-control"  value={{ \Carbon\Carbon::now() }} >  
                            ...
                            <td>
                                <input type="text" id="t66a" name="members[{{ $i }}][t66a]" class="form-control" value="{{number_format(($member->t66a),0, '.','')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t66a" name="members[{{ $i }}][t66a]" class="form-control" value="{{$member->t66a}}">
                            </td>
                            @endif    
               ...
               @foreach ($tes as $member)
                    <tr>
                      ...
                      <th>{{ $member->kec }}</th>
                             ...
                             @if(is_numeric($member->t66a))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t66a),0, '.',' ')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" readonly="true" class="form-control" value="{{$member->t66a}}">
                            </td>
                            @endif    
