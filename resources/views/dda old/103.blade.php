		...
		<div class="main">
			...
			<div class="main-content">
               ...
               <p class="page-title text-left"><a href="data_dda"><i class="lnr lnr-arrow-left-circle"></i> Kembali</a></p>
                  ...
                  <a href="{{ url('/export_103') }}"><button type="button" class="btn btn-primary btn-md">Unduh Template</button></a>
                  <a href="{{ url('/ekspor_103') }}"><button type="button" class="btn btn-primary" style="float: right;background-color:#006fcc;">Ekspor Excel</button></a>
          ...
          <textarea name="catatan" id="catatan" >
              {!! $a->catatan !!}
                 @endforeach
                    ...
                    <button type="submit" class="btn btn-primary show_confirm" data-toggle="tooltip">Kirim</button>
						</form>
