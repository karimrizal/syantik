...
<p class="page-title text-left"><a href="https://webapps.bps.go.id/sultra/syantik/view-metadata/{{$keg_id}}"><i class="lnr lnr-arrow-left-circle"></i> Kembali</a></p>
 ...
 <form class="was-validated" method="post" action="{{ route('indikator.simpan') }}" enctype="multipart/form-data">
                @csrf
                            @if (session('success2'))
        ...
        <strong>Nama: </strong>  
        <input type="text" id="i1" name="i1" class="form-control" placeholder="Tuliskan Nama Indikator" required> <br>
        
        <strong>Definisi Indikator:</strong>
        <textarea class="form-control" style="height:100px" name="i2" id="i2" placeholder="Tuliskan Definisi Indikator" required></textarea>
        
        <strong>Konsep: </strong>  
        <input type="text" id="i3" name="i3" class="form-control" placeholder="Tuliskan Konsep Indikator" required> <br>
        
        <strong>Interpretasi:</strong>
        <textarea class="form-control" style="height:100px" name="i4" id="i4" placeholder="Tuliskan Interpretasi Indikator" required></textarea>
        
        <strong>Metode Penghitungan:</strong>
        <textarea class="form-control" style="height:100px" name="i5" id="i5" placeholder="Tuliskan Metode Penghitungan Indikator" required></textarea>
...
<textarea style="display: none;" class="form-control" id="i6" name="i6" autocapitalize="off" autocomplete="off" autocorrect="off" spellcheck="false"> </textarea> <br>
        ...
        <input type="text" id="i7" name="i7" class="form-control" placeholder="Tuliskan Ukuran" required> <br>
        
        <strong>Satuan: </strong>  
        <input type="text" id="i8" name="i8" class="form-control" placeholder="Tuliskan Satuan" required> <br>
        
        <strong>Klasifikasi Penyajian: </strong>  
        <input type="text" id="i9" name="i9" class="form-control" placeholder="Tuliskan Klasifikasi Penyajian" required> <br>
        
        <strong>Apakah Indikator Komposit? </strong> <br>
        <input type="radio" class="form-check-input" id="ya" name="i10" value="Ya"  required>
        <label class="form-check-label" for="ya">Ya</label> &nbsp &nbsp
        <input type="radio" class="form-check-input" id="tidak" name="i10" value="Tidak"  required>
        ...
        <table class="table table-bordered" id="dynamicAddRemove">
                            ...
                            <td>1</td>    
                            <td>
                               <input type="text" id="i11k1" name="i11k1[0]" class="form-control" placeholder="Tuliskan Nama Indikator Pembangun" >
                            </td>
                            <td> <input type="text" id="i11k2" name="i11k2[0]" class="form-control" placeholder="Tuliskan Sumber Publikasi Ketersediaan" >
                            </td>
        ...
        <table class="table table-bordered" id="dynamicAddRemove2">
                            ...
                            <td>1</td>    
                            <td>
                               <input type="text" id="i12k1" name="i12k1[0]" class="form-control" placeholder="Tuliskan Nama Variabel Pembangun" >
                            </td>
                            <td> <input type="text" id="i12k2" name="i12k2[0]" class="form-control" placeholder="Tuliskan Kegiatan Penghasil Variabel Pembangun" >
                            </td>
        ...
        <input type="text" id="i13" name="i13" class="form-control" placeholder="Tuliskan Level Estimasi" required> <br>
        
        <strong>Apakah Indikator Dapat Diakses Umum? </strong> <br>
        <input type="radio" class="form-check-input" id="ya" name="i14" value="Ya"  required>
        <label class="form-check-label" for="ya">Ya</label> &nbsp &nbsp
        <input type="radio" class="form-check-input" id="tidak" name="i14" value="Tidak"  required>
