...
<p class="page-title text-left"><a href="https://webapps.bps.go.id/sultra/syantik/view-metadata/{{$hasil->id_keg}}"><i class="lnr lnr-arrow-left-circle"></i> Kembali</a></p>
 ...
 <form class="was-validated" method="post" action="{{ route('variabel.update') }}" enctype="multipart/form-data">
                @csrf
                            @if (session('success2'))
        ...
        <strong>Nama: </strong>  
        <input type="text" id="v1" name="v1" class="form-control" placeholder="Tuliskan Nama Variabel" value="{{$hasil->v1}}" required> <br>
        
        <strong>Alias: </strong>  
        <input type="text" id="v2" name="v2" class="form-control" placeholder="Tuliskan Alias Variabel" value="{{$hasil->v2}}" required> <br>
        
        <strong>Definisi Variabel:</strong>
        <textarea class="form-control" style="height:100px" name="v3" id="v3" placeholder="Tuliskan Definisi Variabel" required>{{$hasil->v3}}</textarea>
        
        <strong>Konsep: </strong>  
        <input type="text" id="v4" name="v4" class="form-control" placeholder="Tuliskan Konsep Variabel" value="{{$hasil->v4}}" required> <br>
        
        <strong>Referensi Pemilihan: </strong>  
        <input type="text" id="v5" name="v5" class="form-control" placeholder="Tuliskan Referensi Pemilihan" value="{{$hasil->v5}}" required> <br>
        
        <strong>Referensi Waktu: </strong>  
        <input type="text" id="v6" name="v6" class="form-control" placeholder="Tuliskan Referensi Waktu" value="{{$hasil->v6}}" required> <br>
        
        <strong>Ukuran: </strong>  
        <input type="text" id="v7" name="v7" class="form-control" placeholder="Tuliskan Ukuran" value="{{$hasil->v7}}" required> <br>
        
        <strong>Satuan: </strong>  
        <input type="text" id="v8" name="v8" class="form-control" placeholder="Tuliskan Satuan" value="{{$hasil->v8}}" required> <br>
        
        <strong>Tipe Data: </strong>  
        <input type="text" id="v9" name="v9" class="form-control" placeholder="Tuliskan Tipe Data" value="{{$hasil->v9}}" required> <br>
        ...
        <table class="table table-bordered" id="dynamicAddRemove2">
                    ...
                    @foreach($hasil->v10k1 as $key=>$v10)
                  
                        <tr>
                            <td>1</td>    
                            <td>
                               <input type="text" id="v10k1" name="v10k1[{{$key}}]" class="form-control" value="{{$v10}}" placeholder="Tuliskan Kode Item" required>
                            </td>
                            <td> <input type="text" id="v10k2" name="v10k2[{{$key}}]" class="form-control" value="{{$v10}}" placeholder="Tuliskan Nama Item" required>
                            </td>
                      
                            <td> <button type="button" name="add" id="dynamic-ar2" class="btn btn-outline-primary"><i class="fa-solid fa-plus"></i></button> <button type="button" class="btn btn-outline-danger remove-input-field"><i class="fa-solid fa-trash"></i></button></td>
        ...
        <input type="text" id="v11" name="v11" class="form-control" placeholder="Tuliskan Aturan Validasi" value="{{$hasil->v11}}" required> <br>
        
        <strong>Kalimat Pertanyaan: </strong>  
        <input type="text" id="v12" name="v12" class="form-control" placeholder="Tuliskan Kalimat Pertanyaan" value="{{$hasil->v12}}" required> <br>
        
        <strong>Apakah Variabel Dapat Diakses Umum? </strong> <br>
        <input type="radio" class="form-check-input" id="ya" name="v13" value="Ya" {{ ($hasil->v13=="Ya")? "checked" : "" }}  required>
        <label class="form-check-label" for="ya">Ya</label> &nbsp &nbsp
        <input type="radio" class="form-check-input" id="tidak" name="v13" value="Tidak" {{ ($hasil->v13=="Tidak")? "checked" : "" }}  required>
