			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/syantik/lihat_ddda" class=""><i class="lnr lnr-chart-bars"></i> <span>Data</span></a></li>
						<li>
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<h3 class="panel-title">
                               ...
                               <center>  Metadata Indikator Statistik </center>
                                <br><br><a href="{{ url('/export_indikator/' . $result->meta__indikator_id) }}" class="btn btn-sm">Download</a>
                                @endforeach
                            </h3>
						</div>
                    ...
                    <table class="table table-striped">
                         ...
                         @if(is_null($result->ind_b1k2))
                         @else
                        <tr>
                            <th style="font-weight:700; ">
                           Nama Indikator 
                            </th>
                            <th>{{ $result->ind_b1k2 }} </th>
                        </tr>
                        @endif
                        @if(is_null($result->ind_b1k3))
                        @else
                        <tr>
                            <th style="font-weight:700; ">
                           Konsep  
                            </th>
                            <th>{{ $result->ind_b1k3 }} </th>
                        </tr>
                        @endif
                        @if(is_null($result->ind_b1k4))
                        @else
                        <tr>
                            <th style="font-weight:700; ">
                           Definisi  
                            </th>
                            <th>{{ $result->ind_b1k4 }} </th>
                        </tr>
                        @endif
                        @if(is_null($result->ind_b1k5))
                        @else
                        <tr>
                            <th style="font-weight:700; ">
                           Interpretasi 
                            </th>
                            <th>{{ $result->ind_b1k5 }} </th>
                        </tr>
                        
                        @if(is_null($result->ind_b1k6))
                        @else
                        <tr>
                            <th style="font-weight:700; ">
                           Rumus 
                            </th>
                            <th>{{ $result->ind_b1k6 }} </th>
                        </tr>
                        @endif
                        
                        @if(is_null($result->ind_b1k7))
                        @else
                        <tr>
                            <th style="font-weight:700; ">
                           Ukuran 
                            </th>
                            <th>{{ $result->ind_b1k7 }} </th>
                        </tr>
                        @endif
                        @if(is_null($result->ind_b1k8))
                        @else
                        <tr>
                            <th style="font-weight:700; ">
                           Satuan 
                            </th>
                            <th>{{ $result->ind_b1k8 }} </th>
                        </tr>
                        @endif
                        
                        @if(is_null($result->ind_b1k16))
                        @else
                        <tr>
                            <th style="font-weight:700; ">
                           Level Estimasi 
                            </th>
                            <th>{{ $result->ind_b1k16 }} </th>
                        </tr>
              @endif
                            ...
                            <h4 style="font-weight:700; ">Indikator ini dibentuk dari variabel:</h4>
                            @foreach ($data2 as $kolom)
                            
										<li><a  href="{{ url('variabel/' . $kolom->var_b1k2) }}"> {{ $kolom->var_b1k2 }}
										</a></li> @endforeach  
						</div>
					</div>
				</div>
