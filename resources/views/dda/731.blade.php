                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th><center> {{ $member->satuan }} </center></th>
                         ...
                         <form id="simpan" action="{{ route('dda.store731') }}" method="POST">
                             @csrf
                          ...
                          @if( $a->setuju_opd == 1)
                            ...
                            <td>
                                <input type="text" id="t731a" name="members[{{ $i }}][t731a]" class="form-control" value="{{number_format(($member->t731a),2, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t731a" name="members[{{ $i }}][t731a]" class="form-control" value="{{$member->t731a}}" disabled>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t731b))
                            <td>
                                <input type="text" id="t731b" name="members[{{ $i }}][t731b]" class="form-control" value="{{number_format(($member->t731b),0, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t731b" name="members[{{ $i }}][t731b]" class="form-control" value="{{$member->t731b}}" disabled>
                            </td>
                            @endif
                        ...
                        @elseif( $a->setuju_opd == 0)
                            ...
                            @if(is_numeric($member->t731a))
                            <td>
                                <input type="text" id="t731a" name="members[{{ $i }}][t731a]" class="form-control" value="{{number_format(($member->t731a),2, '.','')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t731a" name="members[{{ $i }}][t731a]" class="form-control" value="{{$member->t731a}}">
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t731b))
                            <td>
                                <input type="text" id="t731b" name="members[{{ $i }}][t731b]" class="form-control" value="{{number_format(($member->t731b),0, '.','')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t731b" name="members[{{ $i }}][t731b]" class="form-control" value="{{$member->t731b}}">
                            </td>
                            @endif
                    ...
                    <tr>
                      ...
                      <th>{{ $member->kec }}</th>
                         <th><center> {{ $member->satuan }} </center></th>
                           ...
                           @if(is_numeric($member->t731a))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t731a),2, '.',' ')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" readonly="true" class="form-control" value="{{$member->t731a}}">
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t731b))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t731b),0, '.',' ')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" readonly="true" class="form-control" value="{{$member->t731b}}">
                            </td>
                            @endif
