	...
	@if (session('success'))
               ...
               <p class="page-title text-left"><a href="data_dda"><i class="lnr lnr-arrow-left-circle"></i> Kembali</a></p>
                           <br>
                            ...
                            <a href="{{ url('/ekspor_dda_223') }}"><button type="button" class="btn btn-primary" style="float: right;background-color:#006fcc;">Ekspor Excel</button></a>
<br>
<br>
					@foreach($kab as $a)				
<h3 class="panel-title" style="font-weight: 500; font-size: 20px; color: #006fcc;">Banyaknya Keputusan DPRD di {{ $a->kab }}, {{$year}}</h3>
@endforeach				
<br>
...
<table class="table table-bordered" id="example3">
                <thead>
                    ...
                    @foreach ($tabel_223 as $i => $member)
                    <tr>
                       
                        <th>{{ $member->kec }}</th>
                        
                         <form id="simpan" action="{{ route('dda.store223') }}" method="POST">
                             @csrf
                          ...
                          @if( $a->setuju_opd == 1)
                               ...
                               @if(is_numeric($member->t223a))
                            <td>
                                <input type="text" id="t223a" name="members[{{ $i }}][t223a]" class="form-control" value="{{number_format(($member->t223a),0, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t223a" name="members[{{ $i }}][t223a]" class="form-control" value="{{$member->t223a}}" disabled>
                            </td>
                            @endif    
                      ...
                      @elseif( $a->setuju_opd == 0)
                        ...
                        @if(is_numeric($member->t223a))
                            <td>
                                <input type="text" id="t223a" name="members[{{ $i }}][t223a]" class="form-control" value="{{number_format(($member->t223a),0, '.','')}}" >
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t223a" name="members[{{ $i }}][t223a]" class="form-control" value="{{$member->t223a}}">
                            </td>
                            @endif    
    ...
    <div class="col-md-6">
        	...
        	<table class="table table-bordered" id="example3">
                <thead>
                 ...
                 <th bgcolor="#5cb85c" style="vertical-align: middle;" > <center>Keputusan</center></th>
                    <th bgcolor="#5cb85c" style="vertical-align: middle;"> 2021</th>
                    ...
                    <tr>
                        <th>{{ $member->kec }}</th>
                         ...
                         @if(is_numeric($member->t223a))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t223a),0, '.',' ')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" readonly="true" class="form-control" value="{{$member->t223a}}">
                            </td>
                            @endif    
