...
@else
<h3 class="panel-title" style="font-weight: 500; font-size: 20px; color: #006fcc;">Jumlah Bayi Lahir, Bayi Berat Badan Lahir Rendah (BBLR), dan Bergizi Kurang Menurut Kecamatan di {{ $a->kab }}, {{$year}}</h3>
@endif
@endforeach				
<br>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                         ...
                         <form id="simpan" action="{{ route('dda.store427') }}" method="POST">
                             @csrf
                          ...
                          @if( $a->setuju_opd == 1)
                            ...
                            <td>
                                <input type="text" id="t427a" name="members[{{ $i }}][t427a]" class="form-control" value="{{number_format(($member->t427a),0, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t427a" name="members[{{ $i }}][t427a]" class="form-control" value="{{$member->t427a}}" disabled>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t427b))
                            <td>
                                <input type="text" id="t427b" name="members[{{ $i }}][t427b]" class="form-control" value="{{number_format(($member->t427b),0, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t427b" name="members[{{ $i }}][t427b]" class="form-control" value="{{$member->t427b}}" disabled>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t427c))
                            <td>
                                <input type="text" id="t427c" name="members[{{ $i }}][t427c]" class="form-control" value="{{number_format(($member->t427c),0, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t427c" name="members[{{ $i }}][t427c]" class="form-control" value="{{$member->t427c}}" disabled>
                            </td>
                            @endif    
                          ...
                          @elseif( $a->setuju_opd == 0)
                           ...
                           @if(is_numeric($member->t427a))
                            <td>
                                <input type="text" id="t427a" name="members[{{ $i }}][t427a]" class="form-control" value="{{number_format(($member->t427a),0, '.','')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t427a" name="members[{{ $i }}][t427a]" class="form-control" value="{{$member->t427a}}">
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t427b))
                            <td>
                                <input type="text" id="t427b" name="members[{{ $i }}][t427b]" class="form-control" value="{{number_format(($member->t427b),0, '.','')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t427b" name="members[{{ $i }}][t427b]" class="form-control" value="{{$member->t427b}}">
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t427c))
                            <td>
                                <input type="text" id="t427c" name="members[{{ $i }}][t427c]" class="form-control" value="{{number_format(($member->t427c),0, '.','')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t427c" name="members[{{ $i }}][t427c]" class="form-control" value="{{$member->t427c}}">
                            </td>
                            @endif   
               ...
               @foreach ($tes as $member)
                    <tr>
                      ...
                      <th>{{ $member->kec }}</th>
                              ...
                              @if(is_numeric($member->t427a))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t427a),0, '.',' ')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" readonly="true" class="form-control" value="{{$member->t427a}}">
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t427b))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t427b),0, '.',' ')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" readonly="true" class="form-control" value="{{$member->t427b}}">
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t427c))
                            <td>
                                <input type="text" readonly="true" class="form-control" value="{{number_format(($member->t427c),0, '.',' ')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" readonly="true" class="form-control" value="{{$member->t427c}}">
                            </td>
                            @endif    
