                        ...
                        <th>{{ $member->kec }}</th>
                         ...
                         <form id="simpan" action="{{ route('dda.store66') }}" method="POST">
                          ...
                          @if( $a->setuju_opd == 1)
                            ...
                            <td>
                                <input type="text" id="t66a" name="members[{{ $i }}][t66a]" class="form-control" value="{{number_format(($member->t66a),0, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t66a" name="members[{{ $i }}][t66a]" class="form-control" value="{{$member->t66a}}" disabled>
                            </td>
                            @endif    
