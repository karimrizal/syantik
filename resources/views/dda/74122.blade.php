                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                         ...
                         <form id="simpan" action="{{ route('dda.store74122') }}" method="POST">
                             @csrf
                           ...
                           <input type="hidden" id="updated_at" name="members[{{ $i }}][updated_at]" class="form-control"  value={{ \Carbon\Carbon::now() }} >  
                            ...
                            <td>
                                <input type="text" id="t74122a" name="members[{{ $i }}][t74122a]" class="form-control" value="{{number_format(($member->t74122a),0, '.','')}}">
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t74122a" name="members[{{ $i }}][t74122a]" class="form-control" value="{{$member->t74122a}}">
                            </td>
                            @endif    
