...
<div class="card-header">    </div>
    ...
    @if (session('success'))
               ...
               <p class="page-title text-left"><a href="data_dda"><i class="lnr lnr-arrow-left-circle"></i> Kembali</a></p>
                           ...
                           <a href="{{ url('/ekspor_dda_67') }}"><button type="button" class="btn btn-primary" style="float: right;background-color:#006fcc;">Ekspor Excel</button></a>
<br>
<br>    
					@foreach($kab as $a)				
                        ...
                        <th>{{ $member->kec }}</th>
                         ...
                         <form id="simpan" action="{{ route('dda.store67') }}" method="POST">
                          ...
                          @if( $a->setuju_opd == 1)
                            ...
                            <td>
                                <input type="text" id="t67a" name="members[{{ $i }}][t67a]" class="form-control" value="{{number_format(($member->t67a),0, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t67a" name="members[{{ $i }}][t67a]" class="form-control" value="{{$member->t67a}}" disabled>
                            </td>
                            @endif    
                            
                             @if(is_numeric($member->t67b))
                            <td>
                                <input type="text" id="t67b" name="members[{{ $i }}][t67b]" class="form-control" value="{{number_format(($member->t67b),0, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t67b" name="members[{{ $i }}][t67b]" class="form-control" value="{{$member->t67b}}" disabled>
                            </td>
                            @endif
                            
                             @if(is_numeric($member->t67c))
                            <td>
                                <input type="text" id="t67c" name="members[{{ $i }}][t67c]" class="form-control" value="{{number_format(($member->t67c),0, '.','')}}" disabled>
                            </td>
                           
                           @else
                              <td>
                                <input type="text" id="t67c" name="members[{{ $i }}][t67c]" class="form-control" value="{{$member->t67c}}" disabled>
                            </td>
                            @endif    
