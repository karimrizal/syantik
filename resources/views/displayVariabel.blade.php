...
<body>
	...
	<div id="wrapper">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="rekomendasi.html" class=""><i class="lnr lnr-file-empty"></i> <span>Rekomendasi</span></a></li>
		...
		<div class="main">
			...
			<h3 class="panel-title" style="font-weight: 500; font-size: 20px; color: #006fcc;">Metadata Variabel</h3>
<br>
                            <table width=100%>
        <tr>
            <th width="150"  style="height:40px" > Nama Variabel </th> 
            @foreach ($metadatas_var as $kolom)
			<td> {{ $kolom->var_b1k2 }}</td> @endforeach  

        </tr>
        
        <tr>
            <th style="height:40px"> Konsep </th> 
            @foreach ($metadatas_var as $kolom)
			<td> {{ $kolom->var_b1k4}}</td> @endforeach  

        </tr>
        
         <tr>
            <th style="height:40px"> Definisi </th> 
            @foreach ($metadatas_var as $kolom)
			<td> {{ $kolom->var_b1k5}}</td> @endforeach  
