...
<div class="card-header">    </div>
    ...
    @endif
						...
						<hr><a href="#"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahVideo" style="font-size: 16px;"><i class="fa fa-plus-circle"></i> Tambah User</button></a><hr>
												...
												<form action="{{ route('postssss.register') }}" method="post">
    														@csrf
					...
					<div class="form-group">
						...
						<option value ="Admin BPS">Admin BPS</option>
						<option value ="Admin BPS Kabupaten">Admin BPS Kabupaten</option>
						<option value ="Walidata">Walidata</option>
						<option value ="Sekretariat Forum">Sekretariat Forum</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="idkab" class="form-control" >
						<option value>Pilih Kabupaten/Kota</option>
                        <option value ="7400">7400 - Sulawesi Tenggara</option>
						<option value ="7401">7401 - Buton</option>
						<option value ="7402">7402 - Muna</option>
						<option value ="7403">7403 - Konawe</option>
						<option value ="7404">7404 - Kolaka</option>
						<option value ="7405">7405 - Konawe Selatan</option>
						<option value ="7406">7406 - Bombana</option>
						<option value ="7407">7407 - Wakatobi</option>
						<option value ="7408">7408 - Kolaka Utara</option>
						<option value ="7409">7409 - Buton Utara</option>
						<option value ="7410">7410 - Konawe Utara</option>
						<option value ="7411">7411 - Kolaka Timur</option>
						<option value ="7412">7412 - Konawe Kepulauan</option>
						<option value ="7413">7413 - Muna Barat</option>
						<option value ="7414">7414 - Buton Tengah</option>
						<option value ="7415">7415 - Buton Selatan</option>
						<option value ="7471">7471 - Kota Kendari</option>
						<option value ="7472">7472 - Kota Baubau</option>
                ...
                <thead>
                    ...
                    <tr>
						...
						<form action="{{ route('postssss.destroy5', $post->id) }}" method="POST">
					...
					<div class="modal fade" id="practice_modal3" >
                        <div class="modal-dialog modal-xl" role="document">
                           <form id="companydata3">
                                <div class="modal-content">
								<div class="modal-header"  style="background-color: #006fcc; color:#FFF;">
														  <h3 class="modal-title" id="tambahlabel">Edit User</h3>
														</div>
