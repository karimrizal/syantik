	...
	<!-- LEFT SIDEBAR -->
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="/syantik/" class="active"><i class="lnr lnr-home"></i> <span>Beranda</span></a></li>
						...
						<li>
							...
							<div id="subPages" class="collapse in">
								<ul class="nav nav">
									...
									<li><a href="view_metadata_indikator" class=""><i class="lnr lnr-database"></i>Metadata Indikator</a></li>
									<li><a href="view_metadata_variabel" class="active"><i class="lnr lnr-database"></i>Metadata Variabel</a></li>
								</ul>
							</div>
						</li>
							...
							<table id="example" class="table table-striped display nowrap" style="width: 100%">
								...
								<tbody>
									@foreach ($list_meta_variabel as $result)
										<tr id="vid{{ $result->id }}">
											<td><a href="{{ url('variabel/' . $result->var_b1k2) }}">{{ $result->var_b1k2 }}</a></td>
											<td><a href="{{ url('/export_variabel/' . $result->id) }}" class="lnr lnr-download"></a></td>
										</tr>
									@endforeach
								</tbody>
							</table>
