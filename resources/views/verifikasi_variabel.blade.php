						  ...
						  @if( (Auth::user()->role == 'Admin BPS')  || (Auth::user()->role == 'Walidata') || (Auth::user()->role == 'Admin OPD') || (Auth::user()->role == 'Operator OPD') || (Auth::user()->role == 'Admin BPS Kabupaten') ) <li>
							...
							<div id="subPages2" class="collapse in" aria-expanded="false" style="">
								<ul class="nav">
								    ...
								    <li><a href="verifikasi_variabel" class="active">Hasil Verifikasi Variabel</a></li>
								    ...
								    <li><a href="verifikasi_variabel" class="active">Verifikasi Variabel</a></li>@endif
								</ul>
							</div>
						</li> @else @endif
											...
											<td> @if($result->status_opd =='Tampil')<center> <i class="fa fa-check" style="color:green"></i></center>
                                              ...
                                              @elseif(is_null($result->status_wali) || $result->status_wali == 'Tidak Tampil'  )
                                                ...
                                                @elseif (is_null($result->status_tampil) && $result->status_wali == 'Tampil' )
                                                 <td> <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_variabel/' . $result->id) }}'" class="btn btn-primary btn-sm">Verifikasi</button>
                                                  </td>
                                ...
                                <div class="modal-body">
                                 ...
                                 <div class="modal-footer">
                                     <button type="button" class="btn btn-default" data-dismiss="modal">Kembali</button>
                                                 ...
                                                 <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_variabel/' . $result->id) }}'" class="btn btn-primary btn-sm">Ubah Verifikasi</button>	
                                             ...
                                             <br>
                                             <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_kegiatan/' . $result->id) }}'" class="btn btn-primary btn-sm">Ubah Verifikasi</button>	
											...
											<td> @if($result->status_opd =='Tampil')<center> <i class="fa fa-check" style="color:green"></i></center>
                                              ...
                                              @if(is_null($result->status_opd))
                                                ...
                                                @elseif (is_null($result->status_wali) && $result->status_opd == 'Tampil' )
                                                 <td> <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_variabel_wali/' . $result->id) }}'" class="btn btn-primary btn-sm">Verifikasi</button>
                                                  </td>
                                ...
                                <div class="modal-body">
                                 ...
                                 <div class="modal-footer">
                                     <button type="button" class="btn btn-default" data-dismiss="modal">Kembali</button>
                                                 ...
                                                 <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_variabel_wali/' . $result->id) }}'" class="btn btn-primary btn-sm">Ubah Verifikasi</button>	
                        ...
                        <div class="modal-dialog">
                           <form id="companydata6">
							...
							<table id="example" class="table table-striped" style="width: 100%">
								...
								<tbody>
									@foreach ($list_meta_variabel_opd as $result)
										<tr id="iid{{ $result->id }}">
										    <td>{{ $result->organisasi }}</td>
											<td>{{ $result->var_b1k2 }}</td>
                                                ...
                                                @if (is_null($result->status_opd)  )
                                                 <td> <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_variabel_opd/' . $result->id) }}'" class="btn btn-primary btn-sm">Verifikasi</button>
                                                  </td>
                                             ...
                                             <br>
                                             <button onclick="location.href='{{ url('https://webapps.bps.go.id/sultra/syantik/verifikasi_variabel_opd/' . $result->id) }}'" class="btn btn-primary btn-sm">Ubah Verifikasi</button>	
