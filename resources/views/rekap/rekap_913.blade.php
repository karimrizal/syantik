               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      <th>{{ $member->idkab }}</th>
                            ...
                            @if($member->t913a == $member->t913a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t913a_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t913a_k),2, '.',' ')}} </center> </td>  @endif
        
        @if($member->t913b == $member->t913b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t913b_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t913b_k),2, '.',' ')}} </center> </td>  @endif
        
        @if($member->t913c == $member->t913c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t913c_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t913c_k),2, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t913d == $member->t913d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t913d_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t913d_k),2, '.',' ')}} </center> </td>  @endif
