        	...
        	<table class="table table-bordered" id="example3">
               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      @if($member->t911a == $member->t911a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t911a_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t911a_k),2, '.',' ')}} </center> </td>  @endif
        
        @if($member->t911b == $member->t911b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t911b_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t911b_k),2, '.',' ')}} </center> </td>  @endif
        
        @if($member->t911c == $member->t911c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t911c_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t911c_k),2, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t911d == $member->t911d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t911d_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t911d_k),2, '.',' ')}} </center> </td>  @endif
