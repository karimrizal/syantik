        	...
        	<table class="table table-bordered" id="example4">
               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      @if($member->t921a == $member->t921a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t921a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t921a_k),0, '.',' ')}} </center> </td>  @endif
