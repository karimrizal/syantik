               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      <th>{{ $member->idkab }}</th>
                             ...
                             @if($member->t455a == $member->t455a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t455a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t455a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t455b == $member->t455b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t455b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t455b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t455c == $member->t455c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t455c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t455c_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t455d == $member->t455d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t455d_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t455d_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t455e == $member->t455e_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t455e_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t455e_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t455f == $member->t455f_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t455f_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t455f_k),0, '.',' ')}} </center> </td>  @endif
