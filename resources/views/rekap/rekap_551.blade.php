               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      <th>{{ $member->idkab }}</th>
                        ...
                        @if($member->t551a == $member->t551a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t551a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t551a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t551b == $member->t551b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t551b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t551b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t551c == $member->t551c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t551c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t551c_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t551d == $member->t551d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t551d_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t551d_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t551e == $member->t551e_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t551e_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t551e_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t551f == $member->t551f_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t551f_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t551f_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t551g == $member->t551g_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t551g_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t551g_k),0, '.',' ')}} </center> </td>  @endif
