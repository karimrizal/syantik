        	...
        	<table class="table table-bordered" id="example4">
               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      @if($member->t553a == $member->t553a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t553a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t553a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t553b == $member->t553b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t553b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t553b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t553c == $member->t553c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t553c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t553c_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t553d == $member->t553d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t553d_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t553d_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t553e == $member->t553e_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t553e_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t553e_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t553f == $member->t553f_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t553f_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t553f_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t553g == $member->t553g_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t553g_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t553g_k),0, '.',' ')}} </center> </td>  @endif
