             ...
             <tr>
               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      @if($member->t914a == $member->t914a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t914a_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t914a_k),2, '.',' ')}} </center> </td>  @endif
        
        @if($member->t914b == $member->t914b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t914b_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t914b_k),2, '.',' ')}} </center> </td>  @endif
        
        @if($member->t914c == $member->t914c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t914c_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t914c_k),2, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t914d == $member->t914d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t914d_k),2, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t914d_k),2, '.',' ')}} </center> </td>  @endif
