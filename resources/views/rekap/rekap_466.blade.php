               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      <th>{{ $member->idkab }}</th>
                            ...
                            @if($member->t466a == $member->t466a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t466a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t466a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t466b == $member->t466b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t466b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t466b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t466c == $member->t466c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t466c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t466c_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t466d == $member->t466d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t466d_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t466d_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t466e == $member->t466e_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t466e_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t466e_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t466f == $member->t466f_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t466f_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t466f_k),0, '.',' ')}} </center> </td>  @endif
