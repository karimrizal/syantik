               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      <th>{{ $member->idkab }}</th>
                       ...
                       @if($member->t427a == $member->t427a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t427a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t427a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t427b == $member->t427b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t427b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t427b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t427c == $member->t427c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t427c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t427c_k),0, '.',' ')}} </center> </td>  @endif
