               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      <th>{{ $member->idkab }}</th>
                                  ...
                                  @if($member->t425a == $member->t425a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t425a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t425a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t425b == $member->t425b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t425b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t425b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t425c == $member->t425c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t425c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t425c_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t425d == $member->t425d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t425d_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t425d_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t425e == $member->t425e_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t425e_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t425e_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t425f == $member->t425f_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t425f_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t425f_k),0, '.',' ')}} </center> </td>  @endif
