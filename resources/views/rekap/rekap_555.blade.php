               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      <th>{{ $member->idkab }}</th>
                       ...
                       @if($member->t555a == $member->t555a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t555a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t555a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t555b == $member->t555b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t555b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t555b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t555c == $member->t555c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t555c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t555c_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t555d == $member->t555d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t555d_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t555d_k),0, '.',' ')}} </center> </td>  @endif
