        	...
        	<table class="table table-bordered" id="example3">
               ...
               @foreach ($perbandingan as $member)
                    <tr>
                     ...
                     @if($member->t63a == $member->t63a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t63a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t63a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t63b == $member->t63b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t63b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t63b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t63c == $member->t63c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t63c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t63c_k),0, '.',' ')}} </center> </td>  @endif
