        	...
        	<table class="table table-bordered" id="example4">
               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      @if($member->t532a == $member->t532a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t532b == $member->t532b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t532c == $member->t532c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532c_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t532d == $member->t532d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532d_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532d_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t532e == $member->t532e_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532e_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532e_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t532f == $member->t532f_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532f_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532f_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t532g == $member->t532g_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532g_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532g_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t532h == $member->t532h_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532h_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532h_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t532i == $member->t532i_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532i_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532i_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t532j == $member->t532j_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532j_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532j_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t532k == $member->t532k_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532k_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532k_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t532l == $member->t532l_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532l_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532l_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t532m == $member->t532m_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t532m_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t532m_k),0, '.',' ')}} </center> </td>  @endif
