...
@else
<h3 class="panel-title" style="font-weight: 500; font-size: 20px; color: #006fcc;">Pencari Kerja Terdaftar, Lowongan Kerja Terdaftar, dan Penempatan/Pemenuhan Tenaga Kerja Menurut Kecamatan dan Jenis Kelamin di {{ $a->kab }}, {{$year}}</h3>
@endif
@endforeach				
<br>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                         ...
                         @if(is_numeric($member->t3217a_lk))
                            <td>
                                {{number_format(($member->t3217a_lk),0, '.','')}}
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                {{number_format(($member->t3217a_pr),0, '.','')}}
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                {{number_format(($member->t3217b_lk),0, '.','')}}
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                {{number_format(($member->t3217b_pr),0, '.','')}}
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                {{number_format(($member->t3217c_lk),0, '.','')}}
                            </td>
                           ...
                           @else
                            ...
                            <td>
                                {{number_format(($member->t3217c_pr),0, '.','')}}
                            </td>
        ...
        <h3 class="panel-title" style="font-weight: 500; font-size: 20px; color: #006fcc;"> <center> Rekap Kabupaten/Kota</center></h3>
        	<table class="table table-bordered" id="example4">
               ...
               @foreach ($perbandingan as $member)
                   ...
                   @if($member->t3217a_lk == $member->t3217a_lk_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t3217a_lk_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t3217a_lk_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t3217a_pr == $member->t3217a_pr_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t3217a_pr_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t3217a_pr_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t3217a == $member->t3217a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t3217a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t3217a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t3217b_lk == $member->t3217b_lk_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t3217b_lk_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t3217b_lk_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t3217b_pr == $member->t3217b_pr_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t3217b_pr_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t3217b_pr_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t3217b == $member->t3217b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t3217b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t3217b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t3217c_lk == $member->t3217c_lk_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t3217c_lk_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t3217c_lk_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t3217c_pr == $member->t3217c_pr_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t3217c_pr_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t3217c_pr_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t3217c == $member->t3217c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t3217c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t3217c_k),0, '.',' ')}} </center> </td>  @endif
