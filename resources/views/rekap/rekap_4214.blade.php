        	...
        	<table class="table table-bordered" id="example3">
               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      @if($member->t4214a == $member->t4214a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t4214a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t4214a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t4214b == $member->t4214b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t4214b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t4214b_k),0, '.',' ')}} </center> </td>  @endif
