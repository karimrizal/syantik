                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th>{{ $member->kec }}</th>
                            ...
                            <td>
                                {{number_format(($member->t231_lk),0, '.',' ')}}
                            </td>
                           ...
                           @else
                            ...
                            <td>
                               {{number_format(($member->t231_pr),0, '.',' ')}}
                            </td>
            ...
            <tr>
               ...
               @foreach ($perbandingan as $member)
                    <tr>
                        ...
                        @if($member->t231_lk == $member->t231_lk_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t231_lk_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t231_lk_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t231_pr == $member->t231_pr_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t231_pr_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t231_pr_k),0, '.',' ')}} </center> </td>  @endif
                
                @if($member->t231c == $member->t231c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t231c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t231c_k),0, '.',' ')}} </center> </td>  @endif
