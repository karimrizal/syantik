		...
		<div class="main">
			...
			<div class="main-content">
               ...
               <p class="page-title text-left"><a href="data_dda"><i class="lnr lnr-arrow-left-circle"></i> Kembali</a></p>
                           <br>
                            <hr><a href="{{ url('/export_423') }}"><button type="button" class="btn btn-primary btn-md">Unduh Template</button></a>	
                            <a href="{{ url('/ekspor_423') }}"><button type="button" class="btn btn-primary" style="float: right;background-color:#006fcc;">Ekspor Excel</button></a>
<br>
<br>          
					@foreach($kab as $a)
               ...
               @foreach ($perbandingan as $member)
                    <tr>
                      ...
                      <th>{{ $member->idkab }}</th>
                                              ...
                                              @if($member->t423a == $member->t423a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t423a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t423a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t423b == $member->t423b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t423b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t423b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t423c == $member->t423c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t423c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t423c_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t423d == $member->t423d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t423d_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t423d_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t423e == $member->t423e_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t423e_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t423e_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t423f == $member->t423f_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t423f_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t423f_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t423g == $member->t423g_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t423g_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t423g_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t423h == $member->t423h_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t423h_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t423h_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t423i == $member->t423i_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t423i_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t423i_k),0, '.',' ')}} </center> </td>  @endif
