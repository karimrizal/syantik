               ...
               @foreach ($tes as $member)
                    <tr>
                      ...
                      <th>{{ $member->idkab }}</th>
                                                              ...
                                                              @if($member->t552a == $member->t552a_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t552a_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t552a_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t552b == $member->t552b_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t552b_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t552b_k),0, '.',' ')}} </center> </td>  @endif
        
        @if($member->t552c == $member->t552c_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t552c_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t552c_k),0, '.',' ')}} </center> </td>  @endif
        
        
        @if($member->t552d == $member->t552d_k)
    <td bgcolor="#73D06F"><center> {{number_format(($member->t552d_k),0, '.',' ')}} </center></td>
        @else <td bgcolor="#F15461"><center> {{number_format(($member->t552d_k),0, '.',' ')}} </center> </td>  @endif
