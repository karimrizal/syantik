...
<!-- WRAPPER -->
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="row">
					<div id="belajar" class="panel-body">	
						<ul  class="nav nav-pills">
						    ...
						    <li class="{{request()->is('verifikasi_rekomendasi') ? 'active' : null }}">
							<a class="nav-link {{request()->is('verifikasi_rekomendasi') ? 'active' : null }}" href="{{url('verifikasi_rekomendasi')}}" role="tab">Verifikasi Rekomendasi Survei</a>
							</li>
							
							<li class="{{request()->is('verifikasi_kompromin') ? 'active' : null }}">
							<a class="nav-link {{request()->is('verifikasi_kompromin') ? 'active' : null }}" href="{{url('verifikasi_kompromin')}}" role="tab">Verifikasi Rekomendasi Kompromin</a>
							</li>
				...
				<div class="tab-content clearfix">
						<div class="tab-pane {{request()->is('verifikasi_rekomendasi') ? 'active' : null }}" id="{{url('verifikasi_rekomendasi')}}" role="tabpanel">
						    <div class="container-fluid">
					<!-- OVERVIEW -->
	...
	<table class="table table-bordered" id="example3">
                <thead>
                    ...
                    <tr>
                        ...
                        @elseif( ($post->status) == 1)  <center> <i class="fa fa-check" style="color:green"></i></center>
                      ...
                      @elseif($post->status_bps == 2)<center> <i class="fa fa-close" style="color:red"></i></center> @else @endif<br>  @if($post->status_bps == '2' )<a href="" id="editCompany2" data-toggle="modal" data-target='#modal_catatanBPS' data-id="{{ $post->id }}">lihat catatan</a>	
    ...
    <div class="modal fade" id="modal_catatanBPS">
                        <div class="modal-dialog">
                           <form id="companydata2">
                               ...
                               <input type="hidden" id="catatanBPS_id" name="catatanBPS_id" value="">
                               <div class="modal-body">
                                    <div class="form-group">
                                        <label for="Judulvid" class="col-form-label">Alasan Tidak Layak:</label>
                                    <input type="text" name="komentar_bps" id="komentar_bps" value="" class="form-control" readonly>
	...
	<div class="modal fade" id="practice_modal3" >
					...
					<div class="tab-pane {{request()->is('verifikasi_kompromin') ? 'active' : null }}" id="{{url('verifikasi_kompromin')}}" role="tabpanel">
...
<table class="table table-bordered" id="example4">
                <thead>
					...
					<td class="text-center">{{ ++$l }}</td>
                        ...
                        @elseif( ($post->status_k) == 1)  <center> <i class="fa fa-check" style="color:green"></i></center>
                        @else Belum Diverifikasi
                        @endif
                        <br>
                      ...
                      @elseif($post->status_k_bps == 2)<center> <i class="fa fa-close" style="color:red"></i></center> @else @endif<br>  @if($post->status_k_bps == '2' ) <a href="#catatanBPS_{{ $post->id }}" data-toggle="modal">Lihat Catatan</a>	

					  <div class="modal fade" id="catatanBPS_{{ $post->id }}">
                        <div class="modal-dialog">
                           <form id="companydata4">
                                <div class="modal-content">
								<div class="modal-header"  style="background-color: #006fcc; color:#FFF;">
    ...
    <div class="modal fade" id="practice_modal4" >
                           ...
                           <form id="companydata3">
								...
								<div class="modal-header"  style="background-color: #006fcc; color:#FFF;">
									...
									<div class="modal-header"  style="background-color: #006fcc; color:#FFF;">
													...
													<div class="form-group">
                        <label for=""><strong>Verifikasi</strong></label>
                        <select name="status_k" class="form-control" id="status_k" >
						...
						<option value ="1">Layak</option>
                                                        ...
                                                        <div class="form-group">
                                                         <textarea class="form-control" style="height:150px" name="komentar_k" id="komentar_k" placeholder="Masukkan Komentar"></textarea>
							                        	</div>
								</div>
...
$('body').on('click', '#editCompany2', function (event) {
    ...
    var id = $(this).data('id');
    console.log(id)
    $.get('catatan_bps/' + id + '/edit_catatanBPS', function (data) {
         $('#userCrudModal').html("Edit category");
         $('#submit').val("Edit category");
         $('#modal_catatanBPS').modal('show');
         $('#catatanBPS_id').val(data.data.id);
...
var id = $(this).data('id');
console.log(id)
$.get('color5/' + id + '/edit5', function (data) {
